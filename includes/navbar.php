<nav class="sticky top-0 l-0 w-full bg-gradient-to-br from-violet-200 to-purple-300 z-50">
  ...
  <div class="sm:hidden navHam hidden duration-300 ease-in-out" id="mobile-menu">
    <div class="space-y-1 px-2 pb-3 pt-2 duration-300 ease-in-out">
      ...
      <a href="webs.php" class="hover:bg-violet-500 hover:text-white block rounded-md px-3 py-2 text-base font-medium">Kumpulan Website</a>
